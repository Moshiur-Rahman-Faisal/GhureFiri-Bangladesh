...
public class CurrentUserPosts extends AppCompatActivity {
...
//Recycler for viewing the information of posts from database
        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Bpost, CurrentUserPosts.PostViewHolder>(options) {
            @Override
            public CurrentUserPosts.PostViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                // Create a new instance of the ViewHolder, in this case we are using a custom
                // layout called R.layout.message for each item
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.post_row, parent, false);

                return new CurrentUserPosts.PostViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(CurrentUserPosts.PostViewHolder holder, int position, Bpost model) {
